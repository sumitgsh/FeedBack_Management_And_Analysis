...
<head>
    ...
    <title>Provide Feedback |Employer</title>
...
if ($conn->connect_error) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        foreach ($_POST as $key => $value) {
            if ($key != 'submit') {
                $rating = "INSERT INTO `feedback` (`feedback_id`, `feedbacker_id`, `question_Id`, `answer`) VALUES ($feedback_id,$employers_Id,$key,'$value')";
